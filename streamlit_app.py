...
It uses the expanded 100-case suite while retaining the original interactive
...
st.caption(
    "100-case reference suite for computational verification, robustness/stability testing, "
...
st.info(
    ...
    "for the disclosed equations and declared placeholder functions across 100 reference cases. "
...
if failed:
    st.error("Failures detected against the 100-case reference suite.")
else:
...
with tabs[0]:
    st.subheader("100-case reference-suite results")
    display_cols = [
    ...
    st.download_button(
        "Download 100-case results as CSV",
